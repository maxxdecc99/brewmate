...
const fieldClassName =
  "w-full rounded-xl border border-line bg-surface px-4 py-3 text-espresso font-medium focus:outline-none focus:border-terracotta transition-colors placeholder:text-muted/60";
